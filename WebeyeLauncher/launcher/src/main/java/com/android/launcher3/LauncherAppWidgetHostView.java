...
public class LauncherAppWidgetHostView extends AppWidgetHostView implements TouchCompleteListener {
    ...
    /* Lenovo-SW zhaoxin5 20150417 make all the widget center in AppWidgetHostView START */
	/*@Override
	 * 
	 * Lenovo-SW zhaoxin5 20150907 XTHREEROW-1426
	public void setAppWidget(int appWidgetId, AppWidgetProviderInfo info) {
		// TODO Auto-generated method stub
		super.setAppWidget(appWidgetId, info);
		setPadding(0, 0, 0, 0);
	}*/    
    /* Lenovo-SW zhaoxin5 20150417 make all the widget center in AppWidgetHostView END */
}
