...
public final class LauncherLog {
    ...
    public static boolean DEBUG_EDITMODE = true;
    ...
    public static final String PROP_DEBUG_EDITMODE = "launcher.debug.editmode";
    /** end */
    ...
    static {
        if (SystemProperties.getBoolean(PROP_DEBUG_ALL, false)) {
            ...
            DEBUG_PERFORMANCE = SystemProperties
                    .getBoolean(PROP_DEBUG_PERFORMANCE, true);
            DEBUG_SURFACEWIDGET = SystemProperties.getBoolean(PROP_DEBUG_SURFACEWIDGET,
                    true);
            ...
            DEBUG_AUTOTESTCASE = SystemProperties.getBoolean(PROP_DEBUG_AUTOTESTCASE,
                    true);
            DEBUG_EDITMODE = SystemProperties.getBoolean(PROP_DEBUG_EDITMODE, true);
        }
    }
    /******************** end ********************/
    ...
    public static void e(String tag, String msg) {
        if(LauncherApplication.mDebug){
            if(LauncherApplication.mIndexLog >= LauncherApplication.mLoglength - 1){
                LauncherApplication.mIndexLog = 0;
            }else{
                LauncherApplication.mIndexLog++;
            }
            if(LauncherApplication.mLogArray != null && LauncherApplication.mLogArray.length > LauncherApplication.mLoglength - 1){
                LauncherApplication.mLogArray[LauncherApplication.mIndexLog] = msg;
            }
        } 
