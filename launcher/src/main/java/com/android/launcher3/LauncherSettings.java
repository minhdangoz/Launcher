...
public class LauncherSettings {
    ...
    public static final class WorkspaceScreens implements ChangeLogColumns {
        ...
        /**
         * Whether the screen if for 2 layer solution, 0 means not, 1 means yes
         * <P>Type: INTEGER</P>
         */
        public static final String SCREEN_FOR_2LAYER_WORKSPACE = "for2layerWorkspace";
    ...
    public static final class Favorites implements BaseLauncherColumns {
        ...
        */
         ...
         * <P>Type: INTEGER</P>
         */
        public static final String FOR_2LAYER_WORKSPACE = "for2layerWorkspace";
        // add end, xutg1, support to switch workspaces between 1 layer and 2 layers
    }
}
