...
public class BubbleTextView extends TextView {
    ...
    public void applyFromShortcutInfo(ShortcutInfo info, IconCache iconCache,
        ...
        iconDrawable.copyBounds(bounds);
        ...
        if (setDefaultPadding) {
            ...
            setCompoundDrawablePadding(grid.iconDrawablePaddingPx - textSize/2 - 5);	
    ...
    public void applyFromApplicationInfo(AppInfo info) {
    	...
    	Resources res = getResources();
    	int textSize = (int) res.getDimension(R.dimen.infomation_count_textsize);
        topDrawable.setBounds(0, -textSize/2, grid.allAppsIconSizePx + textSize, grid.allAppsIconSizePx);	
    ...
    public void setTag(Object tag) {
    	/* Lenovo-SW zhaoxin5 201506062 add for dockview */
    ...
    public int getBitmapCenterY() {
        return (int) (getPaddingTop() + iconHeight / 2.0f);
    }
}
