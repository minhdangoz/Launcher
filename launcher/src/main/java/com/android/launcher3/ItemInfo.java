...
public class ItemInfo {
    ...
    /**
     * Indicates the X position of the associated cell in dockview.
     */
    public int dockCellX = -1;
    ...
    public String toString() {
        return "Item(id=" + this.id + " type=" + this.itemType + " container=" + this.container
            + " screen=" + screenId + " cellX=" + cellX + " cellY=" + cellY + "dockCellX=" +
                dockCellX + " spanX=" + spanX
