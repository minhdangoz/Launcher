...
/**
 * Created by xixionghui on 2016/3/23.
 */
public class HotWordItemDecoration extends RecyclerView.ItemDecoration {

    private int mHorizontalSpacing = 0;
    private int mVerticalSpacing = 0;
    private boolean mIncludeEdge = false;

    public HotWordItemDecoration(int hSpacing, int vSpacing, boolean includeEdge) {
