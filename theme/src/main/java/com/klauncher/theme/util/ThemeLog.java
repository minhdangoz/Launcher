...
package com.klauncher.theme.util;
...
public final class ThemeLog {
    ...
    public static final boolean DEBUG_THEMECONTROLLER = true;
    public static final boolean DEBUG_APKTHEME = true;
    public static final boolean DEBUG_ZIPTHEME = true;
    public static final boolean DEBUG_THEMEUTILS = true;
    public static final boolean DEBUG_APKTHEMEUTILS = false;
    public static final boolean DEBUG_ZIPTHEMEUTILS = true;
    
    private static final String MODULE_NAME = "LauncherTheme";
